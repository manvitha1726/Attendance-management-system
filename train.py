...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"D:\Attendence-System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\t_bg1.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"D:\Attendence-System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\t_btn1.png")
    ...
    def train_classifier(self):
        ...
        #path contains list of all images paths
        faces=[]
        ids=[]
